...
| Title | DOI |
|-------|-----|
| **Fisher Curvature Scaling at Statistical Critical Points** | [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.18827215.svg)](https://doi.org/10.5281/zenodo.18827215) |

---

## Structure

Each subdirectory contains the arXiv submission package for one paper: `main.tex`, figures, and bibliography.

```
paper1-lovelock-bridge/
paper2-operational-qm/
paper3-good-regulator/
...
All papers © 2026 Max Zhuravlev. Preprints shared for academic use.
